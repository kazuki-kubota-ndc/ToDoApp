...
/* ユーザー情報取得 */
exports.map_select_user = function(req, res) {
  res.header("Content-Type", "application/json; charset=utf-8");
  var apiName = '[map_select_user]';
  ...
  async function select_mst(params) {
    ...
    const sql = 'SELECT USER_ID,LOGIN_ID,USER_NAME,ADMIN,FONT_SIZE FROM USER_MST_MAP ORDER BY LOGIN_ID';
    try {

...
/* ログインIDの変更 */
exports.map_update_login_id = function(req, res) {
  res.header("Content-Type", "application/json; charset=utf-8");
  var apiName = '[map_update_login_id]';
  ...
  async function update_login_id(params) {
    ...
    var cnt = 0;
    const dbm = await getPostgresClient();
    const sql = 'UPDATE USER_MST_MAP SET LOGIN_ID = $1 WHERE USER_ID = $2';
    try {
      await dbm.begin();
...
/* ユーザー名変更 */
exports.map_update_user_name = function(req, res) {
  res.header("Content-Type", "application/json; charset=utf-8");
  var apiName = '[map_update_user_name]';
  console.log(apiName+': start');
  var msg = 'user_id:'+req.query.user_id
  ...
  async function update_user_name(params) {
    ...
    var cnt = 0;
    const dbm = await getPostgresClient();
    const sql = 'UPDATE USER_MST_MAP SET USER_NAME = $2 WHERE USER_ID = $1';
    try {
      await dbm.begin();
      const result = await dbm.execute(sql, params);
      cnt = result.rowCount;
...
/* 権限変更 */
exports.map_update_admin = function(req, res) {
  res.header("Content-Type", "application/json; charset=utf-8");
  var apiName = '[map_update_admin]';
  console.log(apiName+': start');
  var msg = 'user_id:'+req.query.user_id
  ...
  async function update_admin(params) {
    ...
    var cnt = 0;
    const dbm = await getPostgresClient();
    const sql = 'UPDATE USER_MST_MAP SET ADMIN = $2 WHERE USER_ID = $1';
    try {
      await dbm.begin();
      const result = await dbm.execute(sql, params);
      cnt = result.rowCount;
...
/* サイズ変更 */
exports.map_update_size = function(req, res) {
  res.header("Content-Type", "application/json; charset=utf-8");
  var apiName = '[map_update_size]';
  console.log(apiName+': start');
  var msg = 'user_id:'+req.query.user_id
  ...
  async function update_size(params) {
    ...
    var cnt = 0;
    const dbm = await getPostgresClient();
    const sql = 'UPDATE USER_MST_MAP SET FONT_SIZE = $2 WHERE USER_ID = $1';
    try {
      await dbm.begin();
      const result = await dbm.execute(sql, params);
      cnt = result.rowCount;
...
/* ユーザー削除 */
exports.map_delete_user = function(req, res) {
  res.header("Content-Type", "application/json; charset=utf-8");
  var apiName = '[map_delete_user]';
  console.log(apiName+': start');
  var msg = 'user_id:'+req.query.user_id;
  console.log(msg);
  ...
  async function delete_user(params) {
    ...
    var cnt = 0;
    const dbm = await getPostgresClient();
    const sql = 'DELETE FROM USER_MST_MAP WHERE USER_ID = $1';
    try {
      await dbm.begin();
      const result = await dbm.execute(sql, params);
      cnt = result.rowCount;
